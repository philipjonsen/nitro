...
const (
	CHOSENSEQ_KEY            string = "coordinator.chosen"            // Never overwritten. Expires or released only
	MSG_COUNT_KEY            string = "coordinator.msgCount"          // Only written by sequencer holding CHOSEN key
	FINALIZED_MSG_COUNT_KEY  string = "coordinator.finalizedMsgCount" // Only written by sequencer holding CHOSEN key
	PRIORITIES_KEY           string = "coordinator.priorities"        // Read only
	WANTS_LOCKOUT_KEY_PREFIX string = "coordinator.liveliness."       // Per server. Only written by self
	MESSAGE_KEY_PREFIX       string = "coordinator.msg."              // Per Message. Only written by sequencer holding CHOSEN
	SIGNATURE_KEY_PREFIX     string = "coordinator.msg.sig."          // Per Message. Only written by sequencer holding CHOSEN
	WANTS_LOCKOUT_VAL        string = "OK"
	INVALID_VAL              string = "INVALID"
